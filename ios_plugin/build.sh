...
# gdvirtual.gen.inc is generated by core/object/make_virtuals.py and
# contains GDVIRTUAL macro expansions for virtual method bindings. It's
# #included inside the Object class body. Our plugin doesn't declare
# GDVIRTUAL methods, so an empty include is fine — the header just
# needs to exist.
if [ ! -f "$GODOT_DIR/core/object/gdvirtual.gen.inc" ]; then
	: > "$GODOT_DIR/core/object/gdvirtual.gen.inc"
	echo "Wrote empty stub gdvirtual.gen.inc"
fi
