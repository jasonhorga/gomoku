...
# source checkout doesn't have it. We only need VERSION_MAJOR (for the
# Godot 3.x vs 4.x guards in our own headers), so stub the rest.
# Hard-coded to 4.5.1 — matches the branch we clone in plugin-build.yml.
