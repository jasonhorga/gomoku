...
echo "  Resume watching: tail -f $SCRIPT_DIR/$TRAIN_LOG"
echo "  Console (raw):   tail -f $SCRIPT_DIR/$CONSOLE_LOG"
...
echo ""
echo "=== Live log (Ctrl-C to stop watching — training continues in background) ==="
touch "$TRAIN_LOG"
